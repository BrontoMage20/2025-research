...
stego_dir="/home/brontomage20/openstego_part2_stegos" #directory containing the stego files
output_dir="/home/brontomage20/openstego_part2_extracted" #directory for extracted files
