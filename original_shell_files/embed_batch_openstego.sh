...
mkdir -p /home/brontomage20/openstego_stegos


# Create a temporary directory for converted bmp files
temp_dir="/home/brontomage20/openstego_temp"
...
cover_dir="/home/brontomage20/cover-images"
...
success=0
failed=0
total=$(ls -1 "$cover_dir"/*.jpg 2>/dev/null | wc -l)
...
# This loop processes every .bmp fie in the cover-images directory.
for cover_file in "$cover_dir"/*.jpg; do
    ...
    # Convert JPG to BMP
    bmp_cover="/home/brontomage20/openstego_temp/${base_name}.bmp"
    ...
    stego_file="/home/brontomage20/openstego_stegos/${base_name}_stego.bmp"
    ...
    # Run the OpenStego command (note that "-mf"="--messagefile", "-cf"="--coverfile", "-sf"="--stegofile", and "-E"="--noencrypt")
...
#rm -rf /home/brontomage20/openstego_temp
...
echo "Output location: /home/brontomage20/openstego_stegos"
