...
mkdir -p ./stegseek_openstego_results
...
#find . -type f -name '*.jpg' | while read -r img; do
#	echo "============="
#	echo "Processing: $img"
#	echo "============="
#	
...
find /home/brontomage20/openstego_stegos -type f -name '*.bmp' | while read -r img; do
	...
	outfile="./stegseek_openstego_results/${filename}.out"
	logfile="./stegseek_openstego_results/${filename}_result.txt"
...
echo "~/Desktop/chal/stegano/archive/stegseek_openstego_results"
echo ""
echo "Statistics:"
...
SUCCESSFUL=0
for file in ./stegseek_openstego_results/*.out; do
